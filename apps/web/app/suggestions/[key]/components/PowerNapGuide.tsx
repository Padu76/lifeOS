...
// Base64 encoded ambient sounds (short samples for demo)
const ambientSounds = {
rain: ‘data:audio/mp3;base64,’, // Placeholder - would need real base64 encoded rain sound
ocean: ‘data:audio/mp3;base64,’, // Placeholder - would need real base64 encoded ocean sound  
forest: ‘data:audio/mp3;base64,’, // Placeholder - would need real base64 encoded forest sound
silence: null
};
...
```
// Using Web Audio API to create gentle, relaxing sounds
...
switch (type) {
  ...
  case 'ocean':
    ...
    oscillator2.frequency.setValueAtTime(0.2, audioContext.currentTime); // Very slow LFO
...
try {
  ...
  // Gentle chime sequence - perfect fifth harmony
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-500/10 border border-blue-400/30 rounded-lg p-4">
            ...
            <ul className="text-blue-100/80 text-sm space-y-1">
              ...
              <li>• La durata ideale è tra 10-20 minuti</li>
            </ul>
          </div>
